		...
		<!-- start 帖子详情-->
			<div class="detail-main" id="js_detail_main">
				<div class="top-content" id="js_detail_scroll_top">
                    ...
                    <section class="" style="white-space: normal; margin: 0px; padding: 0px; max-width: 100%; box-sizing: border-box; color: rgb(62, 62, 62); font-family: 微软雅黑; line-height: 25.6px; border: 0px none; word-wrap: break-word !important; background-color: rgb(255, 255, 255);">
                        <section style="margin: 0px; padding: 0.6em; max-width: 100%; box-sizing: border-box; min-height: 1em; color: rgb(255, 255, 255); border-radius: 0.8em; word-wrap: break-word !important; background: rgb(252, 180, 43);">
                            <section class="" data-autoskip="1" data-bgless="lighten" data-bglessp="30%" style="margin: 0px; padding: 1em; max-width: 100%; box-sizing: border-box; border-radius: 0.8em; color: rgb(193, 126, 0); word-wrap: break-word !important; background: rgb(254, 233, 194);">
                    ...
                    <p>
                        <section class=""  style="white-space: normal; margin: 0px; padding: 0px; max-width: 100%; box-sizing: border-box; border: 0px none; word-wrap: break-word !important;">
                            <section class="" style="margin: 1em auto; padding: 0px; max-width: 100%; box-sizing: border-box; word-wrap: break-word !important;">
                                <section data-width="100%" style="margin: 0px 5px; padding: 0px; max-width: 100%; box-sizing: border-box; border-radius: 0.5em; width: 670px; box-shadow: rgba(0, 0, 0, 0.498039) -3px 3px 5px; word-wrap: break-word !important; background-image: linear-gradient(-135deg, transparent 1em, rgb(85, 136, 170) 0px); background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;">
                                    <section style="margin: 0px; padding: 0px; max-width: 100%; box-sizing: border-box; width: 1.4em; height: 1.4em; float: right; border-bottom-left-radius: 0.5em; box-shadow: rgba(0, 0, 0, 0.2) -2px 2px 3px; word-wrap: break-word !important; background-image: linear-gradient(-135deg, transparent 2em, gray 0px); background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;"></section>
                                    <section class="" style="margin: 0px; padding: 1em 2em 1.5em 1em; max-width: 100%; box-sizing: border-box; word-wrap: break-word; color: rgb(255, 255, 255); line-height: 1.75em;">
